...
exports.initClientRecordingStates = initClientRecordingStates;
...
function initClientRecordingStates() {
...
function shouldRequestBeRecorded(_ref) {
  let {
    url,
    event
  } = _ref;
...
class RecordingMode extends _workboxStrategies.Strategy {
