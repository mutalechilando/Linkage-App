...
declare type AssignmentOptions = {
...
declare class NepaliCalendar extends Temporal.Calendar {
     ...
     */
    dateFromFields(fields: CalendarYMD, options?: AssignmentOptions): Temporal.PlainDate;
    yearMonthFromFields(fields: CalendarYMD, options?: AssignmentOptions): Temporal.PlainYearMonth;
    monthDayFromFields(fields: CalendarYMD, options?: AssignmentOptions): Temporal.PlainMonthDay;
}
