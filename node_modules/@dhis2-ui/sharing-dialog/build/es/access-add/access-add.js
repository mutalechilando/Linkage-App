...
export const AccessAdd = _ref => {
  ...
  }, ["form.__jsx-style-dynamic-selector{background-color:".concat(colors.grey100, ";color:").concat(colors.grey900, ";margin-bottom:21px;padding:8px 12px;border-radius:5px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:flex-end;-webkit-box-align:flex-end;-ms-flex-align:flex-end;align-items:flex-end;gap:").concat(spacers.dp8, ";}"), ".select-wrapper.__jsx-style-dynamic-selector{-webkit-flex:1;-ms-flex:1;flex:1;}"]));
};
AccessAdd.propTypes = {
